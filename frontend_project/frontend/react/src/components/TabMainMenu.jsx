...
function TabMainMenu() {
    ...
    return (
        <>
            <Tabs className="mt-4 flex justify-center">
            <TabList className="mainMenu-tabs__tab-list">
                <Tab selectedClassName="mainMenu-tabs__tab--selected" className='mainMenu-tabs__tab' onClick={ () => navigate('/items')}>管理商品</Tab>
                <Tab selectedClassName="mainMenu-tabs__tab--selected" className='mainMenu-tabs__tab' onClick={ () => navigate('/list')}>お買い物リスト</Tab>
