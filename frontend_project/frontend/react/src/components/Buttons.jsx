...
function OrangeBtn({ onClick, children }){
    return <button type="button" onClick={onClick} class="py-3 px-4 w-60 justify-center inline-flex items-center gap-x-2 text-lg font-medium rounded-lg border border-gray-200 bg-base-orange text-white shadow-sm hover:bg-base-orange-hover disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-neutral-800">
            {children}
            </button>
}
