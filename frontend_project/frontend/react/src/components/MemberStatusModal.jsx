...
function MemberStatusModal({ member, onApprove, onDecline }) {
    ...
    return (
        <>
            <button type="button" className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-slide-up-animation-modal">
                共有
            </button>

            <div id="hs-slide-up-animation-modal" className="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
                                                ...
                                                {friendInvites.length > 0 ? (
                                                    friendInvites.map((m, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="px-6 py-4 text-center whitespace-nowrap text-sm font-medium w-1/4">
                                                                    <button type="button" onClick={() => onDecline(m.member_id)} className="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400">拒否</button>
                                                            </td>
                                                        </tr>
                                                    ))
                                                ) : (
                                                    ...
                                                    {sharedRequests.length > 0 ? (
                                                        sharedRequests.map((m, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td className="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200 w-1/4">{m.list_name}</td>
                                                                <td className="px-6 py-4 text-center whitespace-nowrap text-sm font-medium w-1/4">
                                                                    <button type="button" className="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400"></button>
                                                                </td>
                                                                <td className="px-6 py-4 text-center whitespace-nowrap text-sm font-medium w-1/4">
                                                                    <button type="button" onClick={() => onDecline(m.member_id)} className="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400">中止</button>
                                                                </td>
                                                            </tr>
                                                        ))
                                                    ) : (
